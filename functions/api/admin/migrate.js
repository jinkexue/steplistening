...
const SEED_PROMPTS = [
  ["listening", "generate_dialogue",
    [
      ...
      '    Provide ONE `image_prompt` (<40 words) depicting the two speakers in their setting.',
      '    part_layout = "shared_timer". shared_timer_seconds = 240.',
      '    Return JSON: {title, part_layout:"shared_timer", question_type:"dropdown", transcript, image_prompt, questions:[{q,options,answer}], shared_timer_seconds:240}',
      '',
      ...
      '    Provide ONE `image_prompt` (<40 words) depicting the host and guest in the studio/setting.',
      '    part_layout = "shared_timer". shared_timer_seconds = 180.',
      '    Return JSON: {title, part_layout:"shared_timer", question_type:"radio", transcript, image_prompt, questions:[{q,options,answer}], shared_timer_seconds:180}',
      '',
